              ...
              {VISION_SECTIONS.map((section, si) => (
                <div key={section.title} className="space-y-2">
                  <h5 className="font-black text-sm text-gray-900 flex items-center gap-1.5">
                    <span className="w-5 h-5 shrink-0 rounded-full bg-brand text-white text-2xs font-black flex items-center justify-center">
                      {si + 1}
                    </span>
                    {section.title}
                  </h5>
                  ...
                  {CORE_MINISTRIES.map((m, i) => (
                    <div key={m.name} className="p-3 bg-gray-50 rounded-xl space-y-1">
                      <div className="flex items-center gap-1.5">
                        <span className="w-[18px] h-[18px] shrink-0 rounded-md bg-white border border-gray-200 text-brand text-2xs font-bold flex items-center justify-center">
                          {i + 1}
                        </span>
